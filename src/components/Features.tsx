                ...
                <div className="grid md:grid-cols-3 gap-8">
                    {features.map((feature, index) => (
                        <div key={index} className="p-8 rounded-2xl border border-white/10 bg-white/5 hover:bg-white/10 transition-colors group">
                            <div className="w-12 h-12 bg-isotope-teal/10 rounded-lg flex items-center justify-center mb-6 text-isotope-teal group-hover:scale-110 transition-transform">
