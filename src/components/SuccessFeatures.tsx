            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="grid md:grid-cols-4 gap-6">
                    {features.map((feature, index) => (
                        <div key={index} className="p-6 rounded-2xl border border-white/10 bg-white/[0.02] hover:bg-white/[0.05] hover:border-isotope-teal/30 transition-all duration-300 group flex flex-col items-center text-center hover:-translate-y-1 hover:shadow-[0_0_30px_rgba(0,240,255,0.1)]">
                            <div className="w-12 h-12 bg-isotope-teal/10 rounded-xl flex items-center justify-center mb-6 text-isotope-teal group-hover:scale-110 group-hover:bg-isotope-teal/20 transition-all duration-300">
